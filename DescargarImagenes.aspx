...
<%--                                            Ruta:
    ...
    <asp:UpdatePanel ID="UpdatePanel1" runat="server">
        <ContentTemplate>
            ...
            <br />
            <br />
            <asp:ImageButton ImageUrl="Images/btnDescargar.jpg" AlternateText="Generar" runat="server" OnClick="btnDescargar_Click" ID="btnDescargar"  Visible="false"/>
        </ContentTemplate>
    </asp:UpdatePanel>
    ...
    <asp:UpdatePanel ID="UpdatePanel2" runat="server">
        <ContentTemplate>
            ...
            <br />
            <br />
            <asp:ImageButton ImageUrl="Images/btnGenerar.png" AlternateText="Generar" runat="server" OnClick="btnGenerar_Click" ID="btnDescargar2"  />
        </ContentTemplate>
    </asp:UpdatePanel>
