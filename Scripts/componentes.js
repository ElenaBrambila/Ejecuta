...
function jsShowWindowLoad(mensaje) {
    ...
    imgCentro = "<div style='text-align:center;height:" + alto + "px;'><div  style='color:#000;margin-top:" + heightdivsito + "px; font-size:20px;font-weight:bold'>" + mensaje + "</div><img  src='/Images/ajaxload.gif'></div>";
...
function MensajeExito(mensaje, time) {
...
function MensajeError(mensaje, time) {
    ...
    $("body").append("<div class='Error_'></div>");
  ...
  .animate({ //seleccionamos el div
      opacity: 1 //aparece
          ...
          , function () { //ejecutamos un callback con función anonima para regresar a la normalidad el objeto
              $(".Error_").animate({ //seleccionamos nuevamente el div
                  opacity: 0 //oculta
...
function jsObtieneNombreRandom() {
