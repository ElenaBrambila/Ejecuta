...
{
    public partial class ReporteParticipacionMaster : System.Web.UI.Page
    {
        ...
        protected void btnDescargar_Click(object sender, ImageClickEventArgs e)
        {
            ...
            if (cboClientes.SelectedIndex != -1)
            {
                ...
                if (validarCliente)
                {
                    ...
                    //Necesitamos agregar ahora por tipo de formato (Nacional, regional o mayoreo) su división en segmento
                    ...
                    parameters[1] = new ReportParameter("rptFechas", dtInicio.Text + " al " + dtFin.Text);
