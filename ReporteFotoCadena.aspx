<%@ Page Title="" Language="C#" MasterPageFile="~/Site1.Master" AutoEventWireup="true" CodeBehind="ReporteFotoCadena.aspx.cs" Inherits="IntegramsaUltimate.ReporteFotoCadena" %>
    ...
    <div class="basic-form-area mg-tb-15">
        <div class="container-fluid">
                    ...
                    <div class="sparkline8-list mt-b-30">
                        <div class="sparkline8-hd">
                            <div class="main-sparkline8-hd">
                                <h1>Reporte fotográfico por cadena</h1>
                            </div>
                        </div>
            ...
            <asp:DropDownList runat="server" ID="cboClientes" DataSourceID="sqlCliente" DataTextField="razonSocial" DataValueField="id" AutoPostBack="True" />
                                            ...
                                            <br />
                                            <asp:DropDownList runat="server" ID="cboCadena" DataSourceID="sqlCadenas" DataTextField="nombre" DataValueField="id" AutoPostBack="true" />
                                            ...
                                            <asp:UpdatePanel ID="UpdatePanel1" runat="server">
                                                <ContentTemplate>
                                                    ...
                                                    <asp:ImageButton ImageUrl="Images/btnGenerarXCadena.jpg" AlternateText="Generar reporte por cadena" runat="server" OnClick="btnGenerarPlaza_Click1" ID="btnGenerarCadena" Text="Reporte por cadena" />
                                            ...
                                            <br />
                                            Formato:<br />
                                            <asp:ImageButton runat="server" ID="btnTodasCiudades" ImageUrl="~/Images/sort-icon.png" OnClick="btnTodasCiudades_Click" />
                                            <asp:DropDownList runat="server" ID="cboFormato" DataSourceID="sqlFormatos" DataTextField="Nombre" DataValueField="id" />
                                            ...
                                            <asp:CheckBoxList runat="server" ID="chkFormato" DataSourceID="sqlFormatos" DataTextField="Nombre" DataValueField="idcMunicipio" Visible="false" />
                                            ...
                                            <asp:UpdatePanel ID="UpdatePanel2" runat="server">
                                                <ContentTemplate>
                                                    ...
                                                    <br />
                                                    <br />
                                                    <asp:ImageButton ImageUrl="Images/btnGenerarXFormato.jpg" AlternateText="Generar" runat="server" OnClick="btnGenerar_Click" ID="ImageButton1" />
                                                </ContentTemplate>
                                            </asp:UpdatePanel>
                                        </div>
                                    </div>
