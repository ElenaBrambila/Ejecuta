            ...
            <asp:DropDownList runat="server" ID="cboClientes" DataSourceID="sqlCliente" DataTextField="razonSocial" DataValueField="id" AutoPostBack="True"  />
                                            ...
                                            <asp:UpdatePanel ID="UpdatePanel1" runat="server">
                                                <ContentTemplate>
                                                    ...
                                                    <asp:Button  AlternateText="Generar reporte por cadena" runat="server" OnClick="btnGenerarPlaza_Click1" ID="btnGenerarPlaza" Text="Reporte por cadena" />
                                            ...
                                            <br />
                                            Formato:<br /><asp:ImageButton runat="server" ID="btnTodasCiudades" ImageUrl="~/Images/sort-icon.png" OnClick="btnTodasCiudades_Click"/>
