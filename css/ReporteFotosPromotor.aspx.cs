...
{
    public partial class ReporteFotosPromotor : System.Web.UI.Page
    {
        ...
        protected void btnGenerar_Click(object sender, ImageClickEventArgs e)
        {
            if (cboClientes.SelectedIndex != -1)
            {
                ...
                if (validarCliente)
                {
                    ...
                    //DataTable datosReporte = (DataTable)infoReporte.dtFotosPromotorClienteFecha(fechaInicio, fechaFin, idDeCliente);
