...
<asp:Content ID="Content3" ContentPlaceHolderID="ContentPlaceHolder1" runat="server">
    ...
    <asp:SqlDataSource runat="server" ID="sqlConcentrado" ConnectionString='<%$ ConnectionStrings:IntegramsaUltimateConnectionString %>' SelectCommand="SELECT * FROM [vwReporteParticipacionxFecha] ORDER BY [Participacion] DESC"></asp:SqlDataSource>
</asp:Content>
