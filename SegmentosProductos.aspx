    ...
    <div class="basic-form-area mg-tb-15">
        <div class="container-fluid">
            ...
            <asp:DropDownList runat="server" ID="cboClientes" DataSourceID="sqlCliente" DataTextField="razonSocial" DataValueField="id" AutoPostBack="True" Width="400px" />
                                            ...
                                            <br />
                                            Segmentos:<br />
                                            <asp:DropDownList runat="server" ID="cboSegmentos" DataSourceID="SqlDataSource1" DataTextField="segmento" DataValueField="idSegmento" Width="400px" AutoPostBack="true" OnSelectedIndexChanged="cboSegmentos_SelectedIndexChanged"  />
